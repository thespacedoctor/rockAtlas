...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/rockAtlas.rst']
...
modindex_common_prefix = ["rockAtlas."]
...
latex_documents = [
    ('index', 'rockAtlas.tex', u'rockAtlas Documentation',
     u'Dave Young', 'manual'),
]
...
man_pages = [
    ('index', 'rockAtlas', u'rockAtlas Documentation',
     [u'Dave Young'], 1)
]
...
texinfo_documents = [
    ('index', 'rockAtlas', u'rockAtlas Documentation',
     u'Dave Young', 'rockAtlas', 'A suite of tools to pull known solar-system small-body detections out of ATLAS data',
     'Miscellaneous'),
]
...
def updateUsageRST():
    ...
    from rockAtlas import cl_utils
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["rockAtlas"]
    allSubpackages += findAllSubpackges(
        pathToPackage="rockAtlas"
    )
