    ...
    **Usage:**
    ...
    def _get_orbfit_positions(
        ...
        **Return:**
        ...
        """
        self.log.debug('starting the ``_get_orbfit_positions`` method')
        ...
        self.log.debug('completed the ``_get_orbfit_positions`` method')
    ...
    def _add_orbfit_eph_to_database(
        ...
        **Return:**
            - None
        """
        self.log.debug('starting the ``_add_orbfit_eph_to_database`` method')
        ...
        self.log.debug('completed the ``_add_orbfit_eph_to_database`` method')
        return None
